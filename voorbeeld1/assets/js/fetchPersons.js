...
function loaded() {
    ...
    let buttonGetPersonById = document.getElementById('button_get_person_by_id');
    buttonGetPersonById.addEventListener("click", handleGetPersonById);

    let buttonGetPersonByName = document.getElementById('button_get_person_by name');
